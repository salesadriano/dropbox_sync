...
description: Implement WCAG 2.2 compliant interfaces with mobile accessibility, inclusive design patterns, and assistive technology support. Use when building accessible components, ARIA patterns, focus management, screen-reader support, or mobile accessibility. Prefer accessibility-review for audit-only work and accessibility for remediating existing web UI issues.
---
...
- Converting accessibility requirements into reusable implementation patterns

## When To Prefer Another Skill

- Use `accessibility-review` when the main deliverable is a WCAG audit or design/page assessment.
- Use `accessibility` when the task is primarily to remediate accessibility issues in existing web pages or flows.
- Use this skill when the core work is implementation of accessible patterns, components, and assistive-technology behavior.
