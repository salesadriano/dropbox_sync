...
- Data da versao: 2026-08-18 (**v0.7**)
- Status: **Ciclo 2 de QA aprovado com ressalva** — `lib/json` e `lib/output` entregues, 223 casos, `shellcheck -x` exit 0. Etapa 2 em andamento, sem decisao pendente que a bloqueie
